...
# gene order
gene_order<-read.table("~/single_cell_tools/inferCNV/refdata-gex-GRCh38-2020-A_gen_pos.txt",header = F,row.names = 1)
...
seu<-add_to_seurat(seu,paste0("vol/inferCNV_subcluster_",pat))
